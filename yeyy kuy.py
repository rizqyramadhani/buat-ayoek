...
|__/  |__/ \_______/| $$____/ | $$____/  \____  $$    |_______/ |__/|__/         \___/  |__/  |__/ \_______/ \_______/ \____  $$                                  
    ...
    # Efek animasi ngeruning menggunakan st.empty() untuk mengganti teks
    def tampilkan_ngeruning(teks):
        progress_text = st.empty()  # Menyediakan area untuk teks yang akan diganti
        for i in range(1, len(teks) + 1):
            progress_text.text(teks[:i])  # Mengupdate teks yang ditampilkan
            time.sleep(0.1)  # Memberikan efek animasi setiap 100ms
